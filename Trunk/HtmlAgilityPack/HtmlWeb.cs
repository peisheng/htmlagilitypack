...
namespace HtmlAgilityPack
{
	...
	public partial class HtmlWeb
	{
								   ...
								   ICredentials creds)
		{
			...
			Encoding respenc = null; //!string.IsNullOrEmpty(resp.ContentEncoding)
            ...
            if (!string.IsNullOrEmpty(resp.ContentEncoding))
            {
                ...
                {
                    respenc = null;
                    respenc = getEncoding(req,resp,respenc);
        ...
        private static Encoding getEncoding(HttpWebRequest req, HttpWebResponse resp, Encoding respenc)
        {
